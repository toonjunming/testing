...
public final class RouteSelector {
  ...
  public static String getHostString(InetSocketAddress paramInetSocketAddress) {
  ...
  private void resetNextProxy(HttpUrl paramHttpUrl, Proxy paramProxy) {
    if (paramProxy != null) {
      ...
      if (list != null && !list.isEmpty()) {
        ...
        list = Util.immutableList(new Proxy[] { Proxy.NO_PROXY });
      } 
      this.proxies = list;
    } 
  ...
  public static final class Selection {
    ...
    public Selection(List<Route> param1List) {
